...
export default defineConfig({
  ...
  head: [
    ["link", { rel: "icon", type: "image/svg+xml", href: "/vitePress/vitepress-logo-mini.svg" },],
    ["link", { rel: "icon", type: "image/png", href: "/vitePress/vitepress-logo-mini.png" },],
  ...
  themeConfig: {
    ...
    // 社交链接
    socialLinks: [{ icon: "github", link: "https://github.com/vuejs/vitepress", ariaLabel: "cool link", },],
